...
export type GroupMembersFragmentFragment = { __typename: 'Group', id: string, members: { __typename: 'GroupMemberConnection', edges: Array<{ __typename: 'GroupMemberEdge', node: { __typename: 'GroupMember', user: { __typename: 'Profile', id: string, name: string | null, isMe: boolean | null } | null } }> } | null } & { ' $fragmentName'?: 'GroupMembersFragmentFragment' };
