...
export type Query = {
  ...
  inviteByToken: Maybe<GroupInvite>;
...
export type SettingsPageQuery = { __typename: 'Query', me: { __typename: 'Profile', id: string, name: string | null, avatarUrl: string | null } | null };
...
export type UpdateProfileMutation = { __typename: 'Mutation', updateProfileCollection: { __typename: 'ProfileUpdateResponse', affectedCount: number, records: Array<{ __typename: 'Profile', id: string, name: string | null, avatarUrl: string | null }> } };
...
export type GroupFragmentFragment = (
  ...
  & { ' $fragmentRefs'?: { 'GroupMembersFragmentFragment': GroupMembersFragmentFragment;'GroupCurrencySettingsFragmentFragment': GroupCurrencySettingsFragmentFragment } }
...
export type GroupListFragmentFragment = { __typename: 'Query', groups: { __typename: 'GroupConnection', edges: Array<{ __typename: 'GroupEdge', node: { __typename: 'Group', id: string, name: string, description: string | null } }> } | null } & { ' $fragmentName'?: 'GroupListFragmentFragment' };
...
export type GetInviteQuery = { __typename: 'Query', invite: { __typename: 'GroupInvite', id: string, token: string, groupId: string, email: string | null, group: { __typename: 'Group', id: string, name: string } | null } | null };
